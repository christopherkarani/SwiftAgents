...
public typealias ToolProvider = @Sendable () async -> [HiveToolDefinition]

public protocol MessageIDFactory: Sendable {
...
public protocol MembraneCheckpointAdapter: Sendable {
...
public struct DefaultMessageIDFactory: MessageIDFactory {
    public init() {}
...
public struct NoopToolResultTransformer: ToolResultTransformer {
    public init() {}
...
public struct RuntimeContext: Sendable {
    ...
    public let toolApprovalPolicy: ToolApprovalPolicy
    ...
    public let membraneCheckpointAdapter: (any MembraneCheckpointAdapter)?
...
public struct GraphRuntimeAdapter: Sendable {
    public let runControl: GraphRunController
...
public struct RunResumeRequest: Sendable {
    ...
    public var payload: ChatGraph.Resume
    public var options: HiveRunOptions
...
public struct ExternalWriteRequest: Sendable {
    public var threadID: HiveThreadID
    public var writes: [AnyHiveWrite<ChatGraph.Schema>]
    public var options: HiveRunOptions
...
public struct GraphRunController: Sendable {
    public let runtime: HiveRuntime<ChatGraph.Schema>
    ...
    public func start(_ request: RunStartRequest) async throws -> HiveRunHandle<ChatGraph.Schema> {
    ...
    public func resume(_ request: RunResumeRequest) async throws -> HiveRunHandle<ChatGraph.Schema> {
        try validateRunOptions(request.options)
...
public extension ChatGraph {
    struct Schema: HiveSchema {
        public typealias Context = RuntimeContext
        public typealias Input = String
        public typealias InterruptPayload = ChatGraph.Interrupt
        public typealias ResumePayload = ChatGraph.Resume
